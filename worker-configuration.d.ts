/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 307dec7b2630488aa69789d5d4c01929)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PocketIDContainer";
	}
	interface Env {
		DB: D1Database;
		POCKET_ID_CONTAINER: DurableObjectNamespace<import("./worker/src/index").PocketIDContainer>;
